...
tidyquant::tq_get(c("STX", "FTV", "NOW", "IT", "AMD"),
  ...
  readr::write_csv("C:\\Users\\grant\\Desktop\\IAA\\Spring 1\\spring1-orange5\\Optimization\\Data\\Stock Price Data.csv")

# Read csv
df <- read.csv("C:\\Users\\grant\\Desktop\\IAA\\Spring 1\\spring1-orange5\\Optimization\\Data\\Stock Price Data.csv")
